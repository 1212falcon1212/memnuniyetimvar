...
export default function ReviewDetailError({
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 text-center">
      <h2 className="text-2xl font-bold text-gray-900">Yorum yüklenemedi</h2>
      ...
      <div className="mt-6 flex justify-center gap-3">
        ...
        <Link href="/" className="rounded-lg border border-gray-300 px-6 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
          Ana Sayfa
        </Link>
      </div>
    </div>
