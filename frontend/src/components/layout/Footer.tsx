...
const columns = {
  ...
  markalar: {
    title: "Markalar",
    links: [
      { name: "Trendyol", href: "/firma/trendyol" },
      { name: "Getir", href: "/firma/getir" },
      { name: "THY", href: "/firma/thy" },
      { name: "Hepsiburada", href: "/firma/hepsiburada" },
      { name: "A101", href: "/firma/a101" },
      { name: "Migros", href: "/firma/migros" },
      { name: "BİM", href: "/firma/bim" },
      { name: "Tüm Markalar →", href: "/firma" },
    ],
  },
  cokArananlar: {
    title: "Çok Arananlar",
    links: [
      { name: "Kargo Takip", href: "/arama?q=kargo-takip" },
      { name: "İade", href: "/arama?q=iade" },
      { name: "Müşteri Hizmetleri", href: "/arama?q=musteri-hizmetleri" },
      { name: "Fatura", href: "/arama?q=fatura" },
      { name: "Garanti", href: "/arama?q=garanti" },
      { name: "Trendyol", href: "/arama?q=trendyol" },
      { name: "Tüm Aramalar →", href: "/arama" },
    ],
  },
  trend100: {
    title: "Trend100",
    links: [
      { name: "Turkcell", href: "/firma/turkcell" },
      { name: "Vodafone", href: "/firma/vodafone" },
      { name: "Türk Telekom", href: "/firma/turk-telekom" },
      { name: "Yemeksepeti", href: "/firma/yemeksepeti" },
      { name: "N11", href: "/firma/n11" },
      { name: "Sahibinden", href: "/firma/sahibinden" },
      { name: "LC Waikiki", href: "/firma/lc-waikiki" },
  ...
  konular: {
    ...
    links: [
      { name: "İade", href: "/arama?q=iade" },
      { name: "Servis", href: "/arama?q=servis" },
      { name: "Müşteri Hizmetleri", href: "/arama?q=musteri-hizmetleri" },
      { name: "Ücret", href: "/arama?q=ucret" },
      { name: "Kargo", href: "/arama?q=kargo" },
      { name: "Teslimat", href: "/arama?q=teslimat" },
      { name: "Kalite", href: "/arama?q=kalite" },
      { name: "Tüm Konular →", href: "/arama" },
    ],
  },
};
...
const legalLinks = [
  ...
  { name: "KVKK", href: "/kvkk" },
  { name: "Şeffaflık Politikası", href: "/seffaflik" },
];
